...
api_name = "siteann"
api_desc = "Site Annotation APIs"

coll_name = "c_siteann"
main_id = "contig_id"
main_id_desc = "Contig ID"

search_title = "Site Annotation Search Query"
detail_title = "Site Annotation Detail Query"
...
detail_query_model = api.model(
    detail_title, {main_id: fields.String(required=True, default="2345", description=main_id_desc)}
)
