...
dataset_detail_query_model = api.model(
    ...
    {
        'bcoid': fields.String(required=True, default="ARGOS_000009", description='BCO ID'),
        'dataversion': fields.String(required=False, default="1.51", description='Dataset Release [e.g: 1.51]'),
    }
)
